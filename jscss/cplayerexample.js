!function (e) {
    ...
    function d(e, n, o, t) {
        var r = o ? "" : t.css;
        if (e.styleSheet) e.styleSheet.cssText = x(n, r); else {
    ...
    r.registerLanguage("javascript", l), r.registerLanguage("xml", i), r.initHighlightingOnLoad(), window.addEventListener("load", function () {
        ...
        var e = [{
            ...
            album: "TEXT"
        }, {src: o(33), name: "In my room", artist: "FELT", album: "Grow Color"}], n = new t.default({
    ...
    (function (e) {
        ...
        function i(e) {
            return e.map(function (e, n) {
                ...
                return "string" == typeof e.lyric && (o.lyric = p.decodeLyricStr(e.lyric)), "string" == typeof e.sublyric && (o.sublyric = p.decodeLyricStr(e.sublyric)), o
            })
        }
    ...
    function i(e) {
        for (var n = "", o = !1, t = 0; t < e.length; t++) {
            var r = e.charAt(t), l = /[ぁ-んァ-ン]/.test(r);
    ...
    !function (e) {
        ...
        function l(e) {
            ...
            if (i += e.parentNode ? e.parentNode.className : "", o = A.exec(i)) return x(o[1]) ? o[1] : "no-highlight";
            for (i = i.split(/\s+/), n = 0, t = i.length; n < t; n++) if (l = i[n], r(l) || x(l)) return l
        }
        ...
        function c(e, t, r) {
            ...
            function i(e) {
                ...
                p += "<" + o(e) + w.map.call(e.attributes, t).join("") + ">"
            }
        ...
        function d(e, o, r, l) {
            ...
            function m() {
                var e, o, t, r;
                if (!w.keywords) return n(M);
                for (r = "", o = 0, w.lexemesRe.lastIndex = 0, t = w.lexemesRe.exec(M); t;) r += n(M.substring(o, t.index)), e = s(w, t), e ? (A += e[1], r += f(e[0], n(t[0]))) : r += n(t[0]), o = w.lexemesRe.lastIndex, t = w.lexemesRe.exec(M);
                return r + n(M.substr(o))
            }

            function h() {
                var e = "string" == typeof w.subLanguage;
                if (e && !_[w.subLanguage]) return n(M);
                var o = e ? d(w.subLanguage, M, !0, E[w.subLanguage]) : u(M, w.subLanguage.length ? w.subLanguage : void 0);
                return w.relevance > 0 && (A += o.relevance), e && (E[w.subLanguage] = o.top), f(o.language, o.value, !1, !0)
            }

            function k() {
                L += null != w.subLanguage ? h() : m(), M = ""
            }

            function g(e) {
                L += e.className ? f(e.className, "", !0) : "", w = Object.create(e, {parent: {value: w}})
            }
            ...
            function b(e, n) {
                ...
                if (t) {
                    ...
                    do {
                        w.className && (L += O), w.skip || (A += w.relevance), w = w.parent
                    } while (w !== t.parent);
                    return t.starts && g(t.starts, ""), r.returnEnd ? 0 : n.length
                }
                if (c(n, w)) throw new Error('Illegal lexeme "' + n + '" for mode "' + (w.className || "<unnamed>") + '"');
            ...
            p(y);
            var v, w = l || y, E = {}, L = "";
            for (v = w; v !== y; v = v.parent) v.className && (L = f(v.className, "", !0) + L);
            var M = "", A = 0;
            try {
                for (var C, R, P = 0; ;) {
                    if (w.terminators.lastIndex = P, !(C = w.terminators.exec(o))) break;
                    R = b(o.substring(P, C.index), C[0]), P = C.index + R
                }
                for (b(o.substr(P)), v = w; v.parent; v = v.parent) v.className && (L += O);
                return {relevance: A, value: L, language: e, top: w}
            } catch (e) {
        ...
        function u(e, o) {
            ...
            return o.filter(x).forEach(function (n) {
                var o = d(n, e, !1);
        ...
        var w = [], E = Object.keys, _ = {}, L = {}, M = /^(no-?highlight|plain|text)$/i,
            A = /\blang(?:uage)?-([\w-]+)\b/i, C = /((^(<[^>]+>|\t|)+|(?:\n)))/gm, O = "</span>",
            j = {classPrefix: "hljs-", tabReplace: null, useBR: !1, languages: void 0};
        return e.highlight = d, e.highlightAuto = u, e.fixMarkup = f, e.highlightBlock = h, e.configure = k, e.initHighlighting = g, e.initHighlightingOnLoad = b, e.registerLanguage = y, e.listLanguages = v, e.getLanguage = x, e.inherit = i, e.IDENT_RE = "[a-zA-Z]\\w*", e.UNDERSCORE_IDENT_RE = "[a-zA-Z_]\\w*", e.NUMBER_RE = "\\b\\d+(\\.\\d+)?", e.C_NUMBER_RE = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", e.BINARY_NUMBER_RE = "\\b(0b[01]+)", e.RE_STARTERS_RE = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", e.BACKSLASH_ESCAPE = {
            begin: "\\\\[\\s\\S]",
            relevance: 0
        }, e.APOS_STRING_MODE = {
            className: "string",
    ...
    e.exports = o.p + "bf7a712d59762d46839e35e5358bf29b.mp3"
}, function (e, n, o) {
    e.exports = o.p + "801422833716a4f0f96ff6dff1f77dfe.jpg"
}, function (e, n, o) {
    e.exports = o.p + "8af423669c27d265bb129d04a927044f.mp3"
}, function (e, n, o) {
    e.exports = o.p + "63830807b2600b05fb2b41e6b4f58606.png"
}, function (e, n, o) {
    e.exports = o.p + "0a15e6d713e188edfa6f16810f531985.mp3"
}, function (e, n) {
    function o() {
